...
from src.api.v1 import analytics, chat, evaluator, knowledge, onboarding, voice, voice_agent, rbac
...
app.include_router(evaluator.router, prefix=f"{settings.api_prefix}/evaluator", tags=["Evaluator"])
